...
//ejemplo cogido de : https://stackoverflow.com/questions/11259579/adding-jradiobutton-into-jtable
    ...
    public class MyTableModel extends AbstractTableModel implements PropertyChangeListener {
        ...
        public void setValueAt(Object value, int rowIndex, int columnIndex) {
            if (columnIndex == 1) {
            	...
            	if((boolean) value) {
            		cadena.append(this.getColumnName(columnIndex));
                	
                	System.out.print(this.cadena.toString());
